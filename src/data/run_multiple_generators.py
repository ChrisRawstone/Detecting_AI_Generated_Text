...
def main(number_of_prompts, starting_position, csv_file_name_path):
    ...
    prompt_data(api_key=api_key, df_prompt_meta=df_prompt_meta, 
                df_train_data=df_train_data, number_of_prompts=number_of_prompts, 
                starting_position=starting_position, csv_file_name = csv_file_name_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_file_name_path', type=str, default="data/raw/generated_data/AI_Generated_df1.csv", help='Name of the csv file to save the generated prompts to')
